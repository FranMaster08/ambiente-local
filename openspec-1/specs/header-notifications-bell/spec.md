...
Campanita de notificaciones en el header global: visibilidad solo con sesión, badge de no leídas, panel desplegable, navegación al recurso y comportamiento responsive en `headerTrailing`.
